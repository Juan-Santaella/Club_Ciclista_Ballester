...
<body>
            ...
            <div class="menu" id="show-menu">
                <nav>
                    <ul>
                        ...
                        <li class="menu-selected"><a href="visor_pdf.php" class="text-menu-selected"><i class="fas fa-images"></i> Visor-PDF</a></li>
    ...
    <div class="visor">
        <iframe src="ficheros-adm/Calendario de las Pruebas de Certificación de EOI 2013.pdf" frameborder="0"></iframe>
    </div>
