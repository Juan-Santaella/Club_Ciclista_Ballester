...
<body>
            ...
            <div class="menu" id="show-menu">
                <nav>
                    <ul>
                        ...
                        <li class="menu-selected"><a href="visor_excel_3.php" class="text-menu-selected"><i class="fas fa-images"></i> Visor-Excel</a></li>
    ...
    <div class="visor">
        <iframe src="ficheros-adm/Globalan.htm" frameborder="0"></iframe>
    </div>
