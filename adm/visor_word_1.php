...
<body>
            ...
            <div class="menu" id="show-menu">
                <nav>
                    <ul>
                        ...
                        <li class="menu-selected"><a href="visor_word_1.php" class="text-menu-selected"><i class="fas fa-images"></i> Visor-Word</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="visor">
        <iframe class="visor-iframe" src="ficheros-adm/html/HTML, CSS 1.htm" frameborder="0"></iframe>
    </div>
